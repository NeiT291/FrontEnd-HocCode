...
export default function CreatedPracticeList() {
    ...
    const [editingPractice, setEditingPractice] = useState<Problem | null>(null);
    ...
    const fetchPractices = async () => {
        try {
            setLoading(true);
            const data = await getProblemsCreated(1, 20);
    ...
    const handleEdit = (practice: Problem) => {
                ...
                <div className="flex items-start justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Quản lý các bài thực hành của bạn
                        </p>
                    </div>
                                ...
                                <Link to={`/practice/${practice.id}`}>
                                    <div className="p-5 space-y-3">
                                        ...
                                        <div className="flex flex-wrap gap-2 text-xs">
                                            ...
                                            <span className="px-2 py-0.5 rounded-full bg-gray-100 text-gray-600">
                                                {practice.testcases?.length ?? 0} testcase
                                            </span>
                                        </div>
                                    </div>
                                </Link>
